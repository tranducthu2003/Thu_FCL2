...
class VLT(nn.Module):
    ...
    def centers_initial(self, available_labels_current):
        current_task = available_labels_current
        no_grad_idx = [i for i in range(self.num_classes) if i not in available_labels_current]
